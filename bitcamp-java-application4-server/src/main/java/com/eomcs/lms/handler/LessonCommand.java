...
public class LessonCommand {
  ...
  public void form(ServletRequest request, ServletResponse response) {
    ...
    out.println("<html><head><title>수업 등록 폼</title></head>");
    ...
    out.println("총 수업 시간 : <textarea name='totalHours' rows='5' cols='50'></textarea><br>");
    out.println("일 수업 시간 : <textarea name='dayHours' rows='5' cols='50'></textarea><br>");
