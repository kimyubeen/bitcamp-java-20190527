...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // "추상화"라 부른다.
    // 꼭 데이터만 해당하는 것은 아니다.
    // MemberHabdler 클래스의 경우처럼 특정 업무를 정의하는 것도
    // "추상화"라 부른다.
    ...
    // 차라리 클래스의 이름을 Monster로 변경하는 것이 바람직한다.
    // 이렇게 클래스 목적에 맞지 않는 데이터가 들어갈 수 있다면
    // "추상화"가 무너지게 된다.
    // 이를 방지하기 위해서는 클래스 목적(추상화 목적)에 맞춰
    // 인스턴스변수에 무효한 값이 들어가지 않도록 해야 한다.
    // 그럴 목적으로 만든 문법이 캡슐화이다.
    //
    // "캡슐화"? 추상화가 무너지지 않도록 인스턴스 멤버(변수, 메소드)의 접근을 제어하는 문법이다.
