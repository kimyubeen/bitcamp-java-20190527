...
class Monitor4 {
  ...
  // => 다음과 같이 파라미터의 값을 주지 않으면 기본 파라미터 값을 안 받는 생성자가 호출된다.
  //    예) Monitor4()
  // => 생성자 <== 파라미터를 받지 않는 생성자(파라미터가 없는 생성자)를 
  ...
  Monitor4() { // 생성자
    ...
    // - 다만 현재의 생성자는 기본 생성자로서 외부로부터 값을 받지 않기 떄문에 초기화 블록이랑 다를 바가 없다.
  }
...
public class Test06 {
  public static void main(String[] args) {
    ...
    // Monitor4 m1 = new Monitor4; // 컴파일 오류!
