...
public class HelloApplicationContextListener implements ApplicationContextListener {
  ...
  @Override
  public void contextInitialized(Map<String,Object> beadContainer) {
    startMillis = System.currentTimeMillis();
    System.out.println("수업관리시스템에 오신것을 환영합니다.");
  }
  
  @Override
  public void contextDestroyed(Map<String,Object> beadContainer) {
